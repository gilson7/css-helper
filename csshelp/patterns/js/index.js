...
let objs = [
    ...
    { 
        nome:"tile triangulate",
        data:
        function(){
            let dt = new Image()
            dt.src=`${utf},<svg xmlns="http://www.w3.org/2000/svg" viewBox="71.85 0 500 500" width="500" height="500"><path style="fill: rgba(${colors.front} ,${colors.opacity});" d="M 220.114 256.021 L 427.512 256.02 L 323.812 435.637 Z M 216.188 375 L 71.85 375 L 71.85 125 Z M 321.85 219.312 L 233.276 65.896 L 410.424 65.896 Z M 427.512 375 L 571.85 125 L 571.85 375 Z" /></svg>
        `
        return dt
        }
    }
...
function colorChange(color,inst){
    ...
    if(inst=="back"){
        ...
        colors.back = colory
        document.getElementById("backx")
        .innerHTML = `
            :root{
                --color-back:rgb(${msx.r},${msx.g},${msx.b});
            }
        `
...
function aplly() {
    ...
    objs.forEach(function(item,index){
        ...
        .innerHTML+=`
            <div class="bc">
                <div class="view" id="view${index}"  style="background-image:url(&quot;${item.data().src.replace(/"/gi,"'")}&quot;);"></div>
                <div class="infos"> 
...
colorChange("#81b29a","front")
colorChange("#f2cc8f","back")
//copiando style
