...
function layerClick(value,e){
    ...
    document.getElementById("colorLabel").style.backgroundColor =  rgbToHexInit(objLayers[value][1][5]+")")
    reseTinput(value)
    loadMemuLayers()
}
var arryIds = [
...
function color(inst,value){
    ...
    document.getElementById(inst).value = value
    document.getElementById("colorLabel").style.backgroundColor = value
    apply()
}
let style = ""
let virgula = ","
